    ...
    <CardContent>
      ...
      <FormControl>
        <CardActions>
          <TextField
            ...
            fullWidth
            onChange={(event) =>
              setFilterObject({ ...filterObject, title: event.target.value })
            }
          />
        </CardActions>
        <CardActions>
      ...
      >
            ...
            let filteredMovies = moviesData.filter((movie) => {
              ...
              if (flag && filterObject.title !== undefined) {
                if (
                  !movie.title
                    .toLowerCase()
                    .includes(filterObject.title.toLowerCase())
                )
                  flag = false;
              }
              if (flag && filterObject.genres !== undefined) {
                if (
                  !movie.genres.some((genreName) =>
                    filterObject.genres.includes(genreName)
                  )
                )
                  flag = false;
              }
              ...
              if (flag && filterObject.startDate !== undefined) {
                if (movie.release_date < filterObject.startDate) flag = false;
              }
              if (flag && filterObject.endDate !== undefined) {
                if (movie.release_date > filterObject.endDate) flag = false;
              }
        ...
        <IconButton
          aria-label="delete"
          size="small"
          onClick={() => setMoviesData(defaultData)}
        >
          <DeleteIcon />
        </IconButton>
      </CardActions>
